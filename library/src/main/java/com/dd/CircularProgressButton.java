...
public class CircularProgressButton extends Button {
    ...
    private ColorStateList mPauseColorState;
    ...
    private boolean isPauseToProgress;

    private enum State {
        PROGRESS, IDLE, COMPLETE, ERROR, PAUSE
    }
    ...
    private void initPauseStateDrawable() {
    ...
    protected void drawableStateChanged() {
        if (mState == State.COMPLETE) {
            ...
            initPauseStateDrawable();
            setBackgroundCompat(mPauseStateDrawable);
        }
    ...
    private void morphProgressToPause() {
        ...
        animation.setListener(mPauseStateListener);

        animation.start();

    }

    private OnAnimationEndListener mPauseStateListener = new OnAnimationEndListener() {
        @Override
        public void onAnimationEnd() {
            removeIcon();
            setText(mIdleText);
    ...
    public void setProgress(int progress) {
        ...
        } else if(mProgress == PAUSE_STATE_PROGRESS){
            if (mState == State.PROGRESS) {
    ...
    public boolean isPauseToProgress(){
        return isPauseToProgress;
    }

    public void setPauseToProgress(boolean value){
        isPauseToProgress = value;
    }
